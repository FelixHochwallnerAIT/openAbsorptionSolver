...
#include "absorbedMassFluxObject.H"
#include "volFields.H"
...
{
    defineTypeNameAndDebug(absorbedMassFluxObject, 0);
    addToRunTimeSelectionTable(functionObject, absorbedMassFluxObject, dictionary);
}
}
...
void Foam::functionObjects::absorbedMassFluxObject::writeFileHeader(const label i)
{
...
Foam::functionObjects::absorbedMassFluxObject::calcMassFlux
(
...
Foam::functionObjects::absorbedMassFluxObject::absorbedMassFluxObject
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::absorbedMassFluxObject::read(const dictionary& dict)
{
...
bool Foam::functionObjects::absorbedMassFluxObject::execute()
{
...
bool Foam::functionObjects::absorbedMassFluxObject::write()
{
